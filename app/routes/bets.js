...
*/
    ...
    const disableSecurityCheck = ["4", "1", "6", "13", "14", ...config.raceMarkets, config.Figure];
    ...
    setTimeout(async () => {
      ...
      if (rates?.length > 1 && !multipeResponseForSecurityCheck.find((e) => rates.includes(e)) && !disableSecurityCheck.includes(subMarketId.Id)) {
