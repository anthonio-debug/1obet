        ...
        if (balance < 0) {
          log(
            `${JSON.stringify({
              ...
              calledArea: " difference < loos bal 0 ",
              createdBy: 0,
          ...
          log(
            `${JSON.stringify({
              ...
              credit: lastMaxWithdraw?.credit || 0,
              creditRemaining: lastMaxWithdraw?.creditRemaining || 0,
              calledArea: " difference < loos bal else 0 ",
              createdBy: 0,
              casinoBetAmount: debit,
              event: GameName,
              betDateTime: betTime,
