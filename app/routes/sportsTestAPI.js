...
async function deleteOdds(req, res) {
  ...
  try {
   ...
   await inPlayEvents.deleteOne({Id:'33415386'})
   await inPlayEvents.deleteOne({Id:'33415387'})
   await inPlayEvents.deleteOne({Id:'33415385'})
   await inPlayEvents.deleteOne({Id:'33415388'})
   await inPlayEvents.deleteOne({Id:'33416245'})
   await inPlayEvents.deleteOne({Id:'33416236'})
   await inPlayEvents.deleteOne({Id:'33416279'})
   await inPlayEvents.deleteOne({Id:'33416224'})
   await inPlayEvents.deleteOne({Id:'33416217'})
   await inPlayEvents.deleteOne({Id:'33416557'})
   await inPlayEvents.deleteOne({Id:'33416548'})
   await inPlayEvents.deleteOne({Id:'33416545'})
   await inPlayEvents.deleteOne({Id:'33416671'})
   await inPlayEvents.deleteOne({Id:'33416308'})
   await inPlayEvents.deleteOne({Id:'33416306'})
   await inPlayEvents.deleteOne({Id:'33416435'})
   await inPlayEvents.deleteOne({Id:'33416412'})
   await inPlayEvents.deleteOne({Id:'33416312'})
   await inPlayEvents.deleteOne({Id:'33416573'})
   await inPlayEvents.deleteOne({Id:'33416575'})
   await inPlayEvents.deleteOne({Id:'33416604'})
