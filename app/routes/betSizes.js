      ...
      MarketType.findOne({ marketId }, (err, market) => {
        ...
        BetSizes.findOne(query, (err, data) => {
          ...
          const results = {
            ...
            text: 'Welcome to Exchange.-Announcement :- All casino Profit Loss will be 1 to 10 Ratio from now On.Her casino may Jeet Har 1 ka 10 ho ge. -Welcome . -Welcome . -Welcome to Exchange. Zero commissions on chota bara, kalli jotta, fancies. Customer complain cell 24 hours under maintenance',
          };
          return res.send({
            success: true,
