...
*/
// Define the schema
const inPlayEventsSchemaraces = new mongoose.Schema({
...
inPlayEventsSchemaraces.index({ sportsId: 1 });
inPlayEventsSchemaraces.index({ Id: 1 });
inPlayEventsSchemaraces.index({ status: 1 });
inPlayEventsSchemaraces.index({ isShowed: 1 });
inPlayEventsSchemaraces.index({ CompanySetStatus: 1 });
inPlayEventsSchemaraces.plugin(Global.paginate);
inPlayEventsSchemaraces.plugin(Global.aggregatePaginate);
