      ...
      if (results.length > 0) {
        ...
        if (result.result == -1) {
          ...
          for (const bet of bets) {
            ...
            if(newBetUser.createdBy==46249 || newBetUser.createdBy==11001 || newBetUser.createdBy==46265 || newBetUser.createdBy==46266 || newBetUser.createdBy==46231 || newBetUser.createdBy==46234 || newBetUser.createdBy==46235){
