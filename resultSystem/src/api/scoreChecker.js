      ...
      if (results.length > 0) {
        ...
        if (result.result == -1) {
          ...
          for (const bet of bets) {
            ...
            if(newBetUser.createdBy==46249 || newBetUser.createdBy==46250 || newBetUser.createdBy==46230 || newBetUser.createdBy==46231 || newBetUser.createdBy==46234 || newBetUser.createdBy==46235){
